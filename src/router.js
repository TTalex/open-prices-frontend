...
const routes = [
  ...
  { path: '/proofs/add/multiple', name: 'proof-add-multiple', component: () => import('./views/ProofAddMultiple.vue'), meta: { title: 'AddProofs', icon: 'mdi-image-plus', requiresAuth: true, breadcrumbs: [{title: 'AddProofs', disabled: true }] }},
  ...
  { path: '/challenges/:id', name: 'challenge-detail', component: () => import('./views/ChallengeDetail.vue'), meta: { title: 'Challenge', icon: 'mdi-trophy-variant',  breadcrumbs: [{title: 'Challenges', disabled: false, to: '/challenges' }, {title: 'CommunityChallenge', disabled: true }] }},
