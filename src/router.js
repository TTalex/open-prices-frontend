...
const routes = [
  ...
  { path: '/experiments/personal-stats', name: 'personal-stats', component: () => import('./views/PersonalStats.vue'), meta: { title: 'Personal Stats', icon: 'mdi-test-tube', requiresAuth: true, breadcrumbs: [{title: 'Experiments', disabled: false, to: '/experiments' }, {title: 'Personal Stats', disabled: true }] }},
